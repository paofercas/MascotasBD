    ...
    public void onBindViewHolder(@NonNull MascotaViewHolder holder, int position) {
        ...
        holder.btnlikeMascota.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                holder.txttotalLike.setText(Integer.toString(constructorMascotas.obtenerLikesMascota(mascota)));
                Toast.makeText(activity,"Diste like a "+mascota.getNombre()+" y tiene " +constructorMascotas.obtenerLikesMascota(mascota)+ " likes",Toast.LENGTH_SHORT).show();
                mascota.setIslike(1);
                constructorMascotas.actualizarLikes(mascota);
            }
        });
    }
